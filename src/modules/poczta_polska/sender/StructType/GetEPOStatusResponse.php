...
class GetEPOStatusResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType[]
     */
     ...
     * @param \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType[] $epo
    ...
    /**
     * Get epo value
     * @return \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType[]
     */
    ...
    public static function validateEpoForArrayConstraintFromSetEpo(?array $values = []): string
    {
        ...
        foreach ($values as $getEPOStatusResponseEpoItem) {
            ...
            if (!$getEPOStatusResponseEpoItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The epo property can only contain items of type \XOzymandias\Yii2Postal\sender\StructType\PrzesylkaEPOType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * Set epo value
     * @param \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType[] $epo
     * @return \XOzymandias\Yii2Postal\sender\StructType\GetEPOStatusResponse
     ...
     * @param \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType $item
     * @return \XOzymandias\Yii2Postal\sender\StructType\GetEPOStatusResponse
     *@throws InvalidArgumentException
     */
    public function addToEpo(\XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\PrzesylkaEPOType) {
            throw new InvalidArgumentException(sprintf('The epo property can only contain items of type \XOzymandias\Yii2Postal\sender\StructType\PrzesylkaEPOType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->epo[] = $item;
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getEPOStatusResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getEPOStatusResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

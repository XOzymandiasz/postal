...
class CreateParcelContentResponse extends AbstractStructBase
{
    ...
    public static function validateParcelContentForArrayConstraintFromSetParcelContent(?array $values = []): string
    {
        ...
        foreach ($values as $createParcelContentResponseParcelContentItem) {
            ...
            if (!$createParcelContentResponseParcelContentItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ParcelContentType) {
     ...
     * @param \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ParcelContentType[] $parcelContent
     * @return \XOzymandias\Yii2Postal\sender\StructType\CreateParcelContentResponse
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $createParcelContentResponseErrorItem) {
            // validation for constraint: itemType
            if (!$createParcelContentResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

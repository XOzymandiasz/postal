...
class GetJednostkaOrganizacyjnaResponse extends AbstractStructBase
{
    ...
    public static function validateJednostkaOrganizacyjnaForArrayConstraintFromSetJednostkaOrganizacyjna(?array $values = []): string
    {
        ...
        foreach ($values as $getJednostkaOrganizacyjnaResponseJednostkaOrganizacyjnaItem) {
            ...
            if (!$getJednostkaOrganizacyjnaResponseJednostkaOrganizacyjnaItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\JednostkaOrganizacyjnaType) {
     ...
     * @param \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\JednostkaOrganizacyjnaType[] $jednostkaOrganizacyjna
     * @return \XOzymandias\Yii2Postal\sender\StructType\GetJednostkaOrganizacyjnaResponse
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getJednostkaOrganizacyjnaResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getJednostkaOrganizacyjnaResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

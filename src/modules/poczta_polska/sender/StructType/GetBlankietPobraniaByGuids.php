...
class GetBlankietPobraniaByGuids extends AbstractStructBase
{
     ...
     * @param int $idBufor
     */
    public function __construct(?array $guid = null, ?int $idBufor = null)
    {
        $this
            ->setGuid($guid)
            ->setIdBufor($idBufor);
    ...
    public static function validateGuidForLengthConstraintFromSetGuid(?array $values = null): string
    {
        ...
        foreach (($values ?? []) as $getBlankietPobraniaByGuidsGuidItem) {
            ...
            if (mb_strlen((string) $getBlankietPobraniaByGuidsGuidItem) !== 32) {
     ...
     * @param string[] $guid
     * @return \XOzymandias\Yii2Postal\sender\StructType\GetBlankietPobraniaByGuids
     */

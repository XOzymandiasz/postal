...
class CreateChecklistTemplateResponse extends AbstractStructBase
{
    ...
    public static function validateChecklistTemplateForArrayConstraintFromSetChecklistTemplate(?array $values = []): string
    {
        ...
        foreach ($values as $createChecklistTemplateResponseChecklistTemplateItem) {
            ...
            if (!$createChecklistTemplateResponseChecklistTemplateItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ChecklistTemplateType) {
     ...
     * @param \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ChecklistTemplateType[] $checklistTemplate
     * @return \XOzymandias\Yii2Postal\sender\StructType\CreateChecklistTemplateResponse
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $createChecklistTemplateResponseErrorItem) {
            // validation for constraint: itemType
            if (!$createChecklistTemplateResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

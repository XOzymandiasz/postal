...
class ZwrotDokumentowType extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $rodzajPocztex = null, ?\XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\RodzajListType $rodzajList = null, ?int $odleglosc = null)
    {
        $this
     ...
     * @param string $rodzajPocztex
     * @return \XOzymandias\Yii2Postal\sender\StructType\ZwrotDokumentowType
     *@throws InvalidArgumentException
     * @throws InvalidArgumentException
     * @uses \XOzymandias\Yii2Postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::getValidValues()
     * @uses \XOzymandias\Yii2Postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::valueIsValid()
     */
    public function setRodzajPocztex(?string $rodzajPocztex = null): self
    {
        // validation for constraint: enumeration
        if (!\XOzymandias\Yii2Postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::valueIsValid($rodzajPocztex)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \XOzymandias\Yii2Postal\sender\EnumType\TerminRodzajType', is_array($rodzajPocztex) ? implode(', ', $rodzajPocztex) : var_export($rodzajPocztex, true), implode(', ', \XOzymandias\Yii2Postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::getValidValues())), __LINE__);
        }

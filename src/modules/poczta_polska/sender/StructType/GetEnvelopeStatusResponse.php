...
class GetEnvelopeStatusResponse extends AbstractStructBase
{
     ...
     * @param string $envelopeStatus
     * @return \XOzymandias\Yii2Postal\sender\StructType\GetEnvelopeStatusResponse
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getEnvelopeStatusResponseErrorItem) {
            ...
            if (!$getEnvelopeStatusResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

...
class SzczegolyZawartosciPrzesylkiZagranicznejType extends AbstractStructBase
{
     ...
     * @var string|null
     */
    protected ?string $okreslenieZawartosci = null;
    /**
     * The ilosc
     * @var int|null
     */
     ...
     */
    public function __construct(?string $okreslenieZawartosci = null, ?int $ilosc = null, ?int $masaNetto = null, ?float $wartosc = null, ?string $numerTaryfyHs = null, ?string $krajPochodzeniaKodAlfa2 = null)
    {
        $this

...
class SendEnvelopeResponseType extends AbstractStructBase
{
     ...
     * @param int $idEnvelope
     * @return \XOzymandias\Yii2Postal\sender\StructType\SendEnvelopeResponseType
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $sendEnvelopeResponseTypeErrorItem) {
            ...
            if (!$sendEnvelopeResponseTypeErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

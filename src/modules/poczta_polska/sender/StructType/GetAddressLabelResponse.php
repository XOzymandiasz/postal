...
class GetAddressLabelResponse extends AbstractStructBase
{
    ...
    public static function validateContentForArrayConstraintFromSetContent(?array $values = []): string
    {
        ...
        foreach ($values as $getAddressLabelResponseContentItem) {
            ...
            if (!$getAddressLabelResponseContentItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\AddressLabelContent) {
     ...
     * Set content value
     * @param \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\AddressLabelContent[] $content
     * @return \XOzymandias\Yii2Postal\sender\StructType\GetAddressLabelResponse
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getAddressLabelResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getAddressLabelResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

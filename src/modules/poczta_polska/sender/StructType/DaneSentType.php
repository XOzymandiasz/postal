...
class DaneSentType extends AbstractStructBase
{
     ...
     * @var string|null
     */
    protected ?string $kluczPrzewoznika = null;
    /**
     * The kodCN
     ...
     */
    public function __construct(?string $numer = null, ?string $kluczPrzewoznika = null, ?string $kodCN = null, ?string $kodPKWiU = null, ?float $masa = null, ?bool $proceduraAwaryjna = null)
    {
        $this
            ->setNumer($numer)

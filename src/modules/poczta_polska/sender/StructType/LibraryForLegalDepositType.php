...
class LibraryForLegalDepositType extends AbstractStructBase
{
     ...
     * @param string $city
     */
    public function __construct(?string $idLibraryForLegalDeposit = null, ?string $libraryName = null, ?string $street = null, ?string $houseNumber = null, ?string $apartmentNumber = null, ?string $zipCode = null, ?string $city = null)
    {
        $this

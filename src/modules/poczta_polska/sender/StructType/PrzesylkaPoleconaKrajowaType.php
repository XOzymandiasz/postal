...
class PrzesylkaPoleconaKrajowaType extends PrzesylkaRejestrowanaType
{
     ...
     * Set kategoria value
     * @param string $kategoria
     * @return \XOzymandias\Yii2Postal\sender\StructType\PrzesylkaPoleconaKrajowaType

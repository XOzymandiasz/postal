...
class DownloadIWDContentResponse extends AbstractStructBase
{
     ...
     * @param string $iWDContent
     * @return \XOzymandias\Yii2Postal\sender\StructType\DownloadIWDContentResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $downloadIWDContentResponseErrorItem) {
            ...
            if (!$downloadIWDContentResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

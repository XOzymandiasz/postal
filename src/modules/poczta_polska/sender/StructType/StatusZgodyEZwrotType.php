...
class StatusZgodyEZwrotType extends AbstractStructBase
{
     ...
     * @var string[]
     */
    protected ?array $eZwrotPrzesylki = null;
    /**
     * The guidZgodaEZwrot
     * Meta information extracted from the WSDL
     * - base: xsd:string
     ...
     */
    public function __construct(?array $eZwrotPrzesylki = null, ?string $guidZgodaEZwrot = null, ?string $status = null, ?bool $platnoscZaPrzesylke = null, ?int $kosztKontrahenta = null, ?string $dataWygasnieciaZgody = null)
    {
        $this

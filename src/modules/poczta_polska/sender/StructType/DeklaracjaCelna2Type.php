...
class DeklaracjaCelna2Type extends AbstractStructBase
{
     ...
     * @var string|null
     */
    protected ?string $zawartoscPrzesylki = null;
    /**
     ...
     * @var string|null
     */
    protected ?string $walutaKodISO = null;
    /**
     ...
     */
    public function __construct(?string $rodzaj = null, ?string $zawartoscPrzesylki = null, ?array $dokumentyTowarzyszace = null, ?string $wyjasnienie = null, ?string $oplatyPocztowe = null, ?string $uwagi = null, ?string $numerReferencyjnyImportera = null, ?string $numerTelefonuImportera = null, ?string $walutaKodISO = null, ?array $szczegolyZawartosciPrzesylki = null, ?string $numerReferencyjnyCelny = null)
    {
        $this
            ->setRodzaj($rodzaj)

...
class GetOutboxBookResponse extends AbstractStructBase
{
     ...
     * @param string $pdfContent
     * @return \XOzymandias\Yii2Postal\sender\StructType\GetOutboxBookResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getOutboxBookResponseErrorItem) {
            ...
            if (!$getOutboxBookResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {

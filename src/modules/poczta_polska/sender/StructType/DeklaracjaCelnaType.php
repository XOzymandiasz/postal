...
class DeklaracjaCelnaType extends AbstractStructBase
{
     ...
     */
    public function __construct(?array $szczegoly = null, ?bool $podarunek = null, ?bool $dokument = null, ?bool $probkaHandlowa = null, ?bool $zwrotTowaru = null, ?bool $towary = null, ?bool $inny = null, ?string $wyjasnienie = null, ?string $oplatyPocztowe = null, ?string $uwagi = null, ?string $licencja = null, ?string $swiadectwo = null, ?string $faktura = null, ?string $numerReferencyjnyImportera = null, ?string $numerTelefonuImportera = null, ?string $waluta = null)
    {
        $this

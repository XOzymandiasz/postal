...
class MoveShipmentsResponse extends AbstractStructBase
{
     ...
     * @param string[] $notMovedGuid
     * @return \XOzymandias\Yii2Postal\sender\StructType\MoveShipmentsResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $moveShipmentsResponseErrorItem) {
            // validation for constraint: itemType
            if (!$moveShipmentsResponseErrorItem instanceof \XOzymandias\Yii2Postal\modules\poczta_polska\sender\StructType\ErrorType) {
